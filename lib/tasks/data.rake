...
namespace :data do
  ...
  task :gendered_project => :environment do
    ...
    project = Project.create(name: "Sexism Purge", slug: "sexism-purge",
            ...
            long_description: "<p>Wordset inherited a lot of example sentences that break our rules for what a good example sentence should be. Help us clear out the weird gendered example sentences, many of which are fairly sexist in nature.</p>",
